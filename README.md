...
# Deployment
Here I have created a deployment document that explains the steps I took to deploy my project to Heroku and AWS

## Deployment Document -> [Visit Document](/writeup_files/documents/deployment.md)

# Local Clone
Here I have created a local clone document that explains how to make a local clone of my project.

## Local Clone Document -> [Visit Document](/writeup_files/documents/local_clone.md)
